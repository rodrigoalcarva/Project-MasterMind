...
var placesCor;
var lasTentativas;
var modo= "Countdown (1 min /10 tenta)";
var theplays = 0;
var vitorias = 0;
var derrotas = 0;
...
function game(){
  ...
  if (teamCores){
    ...
    if (l  === SecretCode.length){
      ...
      array = [min + seg];
      var valores = [];
      if (localStorage.getItem("G1/5C") != null){
        theplays = 1 + parseInt(localStorage.getItem("G1/5C"));
        localStorage.setItem("G1/5C", theplays);
      }
      else{
        theplays = 1;
        localStorage.setItem("G1/5C", theplays);
